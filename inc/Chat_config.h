...
#define NUM_APP_GATT_ATTRIBUTES (13 + 9) /* 5 attributes x BLE Chat service characteristics + 9 for OTA Service characteristics */
...
/* Number of attributes requests from the chat demo */
#define NUM_APP_GATT_ATTRIBUTES 13 /* 5 attributes x BLE Chat service characteristics */
...
#elif SERVER
#define ATT_VALUE_ARRAY_SIZE    (44 + 240 + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 44 + Chat  (TX (41) + RX (39) characteristics)   Services
#endif 
